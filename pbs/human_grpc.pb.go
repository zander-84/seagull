...
type HumanServiceClient interface {
	Info(ctx context.Context, in *HumanRequest, opts ...grpc.CallOption) (*HumanResponse, error)
}
...
func (c *humanServiceClient) Info(ctx context.Context, in *HumanRequest, opts ...grpc.CallOption) (*HumanResponse, error) {
	out := new(HumanResponse)
	err := c.cc.Invoke(ctx, "/pbs.HumanService/Info", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HumanServiceServer interface {
	Info(context.Context, *HumanRequest) (*HumanResponse, error)
...
func (UnimplementedHumanServiceServer) Info(context.Context, *HumanRequest) (*HumanResponse, error) {
...
func _HumanService_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HumanRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HumanServiceServer).Info(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pbs.HumanService/Info",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HumanServiceServer).Info(ctx, req.(*HumanRequest))
	}
...
var HumanService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pbs.HumanService",
	HandlerType: (*HumanServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Info",
			Handler:    _HumanService_Info_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/human.proto",
}
